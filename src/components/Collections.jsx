...
const Collections = () => {
  ...
  return (
    <div className="text-center py-10 px-6 bg-gradient-to-b from-pink-100 to-white">
      ...
      {/* Centered Wrapper for Grid */}
      <div className="flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-20 max-w-[90%]">
          {collections.length > 0 ? (
            collections.map((collection, index) => (
              <div key={index} className="group perspective">
                <div className="relative w-46 h-46 preserve-3d duration-700 group-hover:rotate-y-180">
